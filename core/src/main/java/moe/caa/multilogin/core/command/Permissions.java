...
public final class Permissions {
    public static final String COMMAND_MULTI_LOGIN_TAB_COMPLETE = "command.multilogin.tab.complete";
    ...
    public static final String COMMAND_MULTI_LOGIN_YGGDRASIL_LIST = "command.multilogin.yggdrasil.list";
    public static final String COMMAND_MULTI_LOGIN_YGGDRASIL_INFO = "command.multilogin.yggdrasil.info";
